...
router.get('/icu-cases/patients',requirePermission('inventory.view'),action(()=>prisma.patient.findMany({select:{id:true,patientCode:true,firstName:true,lastName:true},orderBy:[{firstName:'asc'},{lastName:'asc'}]})));
